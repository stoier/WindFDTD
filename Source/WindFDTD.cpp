...
//==============================================================================
WindFDTD::WindFDTD (double kIn) : k (kIn) // <- This is an initialiser list. It initialises the member variable 'k' (in the "private" section in OneDWave.h), using the argument of the constructor 'kIn'.
{
    //******
...
void WindFDTD::paint (juce::Graphics& g)
{
...
void WindFDTD::resized()
{
}

void WindFDTD::calculateScheme()
{
...
/*
Path WindFDTD::visualiseState (Graphics& g)
{
...
/*
void WindFDTD::excite (double excitationLoc)
{
