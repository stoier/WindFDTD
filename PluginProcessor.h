...
public:
    ...
    //void setCylinderLength(double cylinderLengthToSet) {cylinderLength = cylinderLengthToSet;};
    
    
    //double cylinderLength=250;
...
private:
    ...
    //WindFDTDVoice windVoice;
    
    //std::unique_ptr<WindFDTDVoice> windVoice; // using a smart pointer for 1D wave class
    //==============================================================================
